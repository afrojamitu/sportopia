...
const Update = () => {
    ...
    const {_id, instructor, banner } = update;
    console.log(_id);
    ...
    return (
        <div>
            <Helmet>
                <title>Update - Sportopia Instructor</title>
            </Helmet>
                        ...
                        <div className='grid md:grid-cols-2 items-center gap-4 w-full'>
                            <div>
                                <div className='grid gap-2 text-lg'>
                                    <label>Name</label>
                                    <input className='w-full py-2 rounded px-3' type="text" name="instructor" id="" placeholder='Type Your Name' defaultValue={user.displayName} readOnly />
                                </div>
